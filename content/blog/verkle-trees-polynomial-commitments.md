...
Step back and consider what we just built. A node with 256 children gets encoded as a polynomial, mapped to a single curve point, and from that point alone a prover can convince you that any one child has a specific value, without revealing anything else about the polynomial. Two curve points, one pairing check, done. It feels like it shouldn't work, like magic of some kind.
